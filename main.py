...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Local Repo Path",
        type=str,
        required=True,
    )
    parser.add_argument(
        "--resource", dest="resource", help="Azure Resource", type=str, required=True
    )
    parser.add_argument(
        "--region", dest="region", help="AWS Region", type=str, required=True
    )
    parser.add_argument(
        "--tag",
        action="append",
