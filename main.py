...
if __name__ == "__main__":
    ...
    if args.resource == "vms":
        ...
        aks_import = AKSImportSetUp(subscription_id=args.subscription_id, region=args.region, resource=args.resource, local_repo_path=args.local_repo_path, filters=args.tag)
